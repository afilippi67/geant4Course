...
def makeGeometry(configuration):
	...
	detector = MyDetector(name="waterBall", mother="root")	
	detector.description = "water ball"
	detector.color       = "00CED1"
	...
	detector.dimensions = "0.*cm  5.*cm  0*deg 360*deg 0*deg 180*deg"
