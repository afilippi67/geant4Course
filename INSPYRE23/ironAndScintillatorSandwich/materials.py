...
def define_materials(configuration):
	...
	#define here new materials following above recipes
	# cellulose
	cellulose = MyMaterial(name="cellulose", description="cellulose for paper",
	ncomponents = "3", components="C 6 H 10 O 5")
	print_mat(configuration, cellulose);
