...
def define_materials(configuration):
	...
	# MyAir
	my_air = MyMaterial(name="my_air", description="homemade air", 
	density="0.001290",
	...
	print_mat(configuration, my_lucite);
        ...
        # baryum sulphate BaS04
        baryumSulphate = MyMaterial(name="baryumSulphate", 
	description="baryum sulphate",
	density = "4.5",
        ncomponents="3",  components="Ba 1 S 1 O 4")
        print_mat(configuration, baryumSulphate);
