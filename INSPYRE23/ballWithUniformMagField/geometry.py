...
def makeGeometry(configuration):
	...
	detector = MyDetector(name="myBall", mother="root")	
	detector.description = "my first ball"
	detector.color       = "1e90ff"
	...
	detector.dimensions = "0.*cm 5.*cm 0*deg 360*deg 0.*deg 360*deg"
        detector.pos = "3*cm 2*cm 2*cm"
	detector.material   = "G4_WATER"	# G4_Si is a GEANT4 defined element name
